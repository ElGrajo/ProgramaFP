...
public class MarcoBoton extends JFrame
{
 ...
 public MarcoBoton()
 {
    ...
    Icon insecto1 = new ImageIcon( getClass().getResource( "nia_01.gif" ) );
    Icon insecto2 = new ImageIcon( getClass().getResource( "nia_04.gif" ) );
 // establece la imagen
    botonJButtonElegante = new JButton( "Boton elegante", insecto1 ); 
// establece la imagen de sustitución
